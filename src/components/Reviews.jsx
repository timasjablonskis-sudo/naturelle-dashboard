...
const reviews = [
  { name: 'Jessica L.', rating: 2, text: 'I had to wait too long for my appointment. The treatment was okay but the wait was frustrating.', aiResponse: 'Hi Jessica, thank you for sharing your feedback. We sincerely apologize for the wait during your visit — this is not the experience we aim for at Lumina Med Spa. We\'d love to make it right. Please call us at (773) 592-9781 so we can address this personally.', status: 'Response Posted', time: '12m ago' },
  { name: 'Emily R.', rating: 5, text: 'Absolutely love Lumina Med Spa! Got my neuromodulators done and the results look so natural. Staff was incredibly professional and made me feel so comfortable!', aiResponse: "Thank you so much, Emily! We're thrilled you love your natural-looking results! Our team takes pride in personalized care. We can't wait to see you again!", status: 'Response Posted', time: '1h ago' },
  { name: 'Sarah M.', rating: 5, text: 'Had a PRP facial and my skin has never looked better. The glow lasted for weeks! The whole experience was so relaxing and personalized.', aiResponse: 'Sarah, this made our day! We love that your natural glow is shining through! Thank you for trusting Lumina Med Spa. See you for your next session!', status: 'Response Posted', time: '3h ago' },
              ...
              {expanded[i] && (
                <div className="mt-2 bg-background border border-primary/20 border-l-2 border-l-primary rounded-lg p-3">
                  <div className="flex items-center gap-1.5 mb-1.5">
                    ...
                    <span className="text-primary font-mono text-[9px]">LUMINA MED SPA · OWNER RESPONSE</span>
                  </div>
