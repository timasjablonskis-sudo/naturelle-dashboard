...
const staticEmails = [
  {
    to: 'Emily R.',
    service: 'Botox',
    subject: 'Your complimentary Botox consultation at Intu Med Spa',
    timestamp: '3m ago',
    status: 'Opened',
    body: `Hi Emily,\n\nThank you for your interest in Botox at Intu Med Spa! We wanted to personally reach out and make sure you have everything you need to take the next step.\n\nBotox at Intu Med Spa starts at just $12/unit, and we're currently running a special: 20 units for $179. Our board-certified providers will assess your goals and create a personalized treatment plan during a complimentary consultation.\n\nWe have availability this week — Tuesday and Thursday 10am–7pm, and Saturday 10am–2pm. Book your free consultation today and get the look you've been thinking about.`,
  },
  {
    to: 'Michael B.',
    service: 'HydraFacial',
  ...
  },
  {
    ...
    timestamp: '1h ago',
    status: 'Delivered',
    body: `Hi Rachel,\n\nWe noticed you inquired about Botox recently and wanted to follow up with some helpful info.\n\nBotox is one of our most popular treatments — quick, virtually painless, and results last 3–4 months. At Intu Med Spa, we offer Botox starting at $12/unit with a current promo of 20 units for $179.\n\nIf you have any questions or want to see before/afters, we're happy to chat. Otherwise, book your free consultation below — we'd love to help you look and feel your best.`,
  },
  {
    to: 'James T.',
    service: 'Weight Loss',
    subject: 'Your personalized weight loss plan starts here',
    timestamp: '2h ago',
    status: 'Opened',
    body: `Hi James,\n\nThank you for your interest in our medical weight loss program at Intu Med Spa. We're proud to offer one of the most effective approaches available.\n\nOur GLP-1 program uses FDA-approved medications like Semaglutide and Tirzepatide, combined with personalized coaching. Programs start at $189/month — and our patients average 15–20 lbs lost in the first 90 days.\n\nBook a free consultation to find out which program is right for you. Our medical team will walk you through everything and design a plan built around your goals.`,
  },
]

function getEmailBody(email) {
  if (email.body) return email.body
  return `Hi ${email.to.split(' ')[0]},\n\nThank you for your interest in ${email.service} at Intu Med Spa. We wanted to personally reach out and make sure you have all the information you need.\n\nWe offer ${email.service} with personalized treatment plans designed for your goals. Book a free consultation and our team will walk you through pricing, availability, and what to expect.\n\nWe look forward to hearing from you!`
}
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 bg-[#131918] border border-[#1E2B28] rounded-xl px-4 py-2">
            <Mail size={13} className="text-[#8BBCAD]" />
            <span className="text-[#8BBCAD] font-mono text-xs font-bold">{allEmails.length} EMAILS SENT TODAY</span>
          </div>
          <div className="flex items-center gap-2 bg-[#131918] border border-[#1E2B28] rounded-xl px-4 py-2">
        ...
        <div className="flex-1 bg-[#131918] border border-[#1E2B28] rounded-xl flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto p-6">
            <div className="max-w-[600px] mx-auto rounded-xl overflow-hidden shadow-xl">
              {/* Email top bar */}
              <div className="px-8 py-4" style={{ background: '#8BBCAD' }}>
                <div className="font-display text-xl text-[#0D1110] tracking-wide">INTU Med Spa</div>
              ...
              <div className="bg-white px-8 py-6">
                ...
                <div className="mb-5 pb-4 border-b border-[#f0f0f0]">
                  <div className="flex items-center gap-2 text-xs text-[#666] mb-1">
                    ...
                    <span>Intu Med Spa &lt;ai@intumedspa.com&gt;</span>
                  </div>
                  <div className="flex items-center gap-2 text-xs text-[#666] mb-1">
                ...
                <div className="mt-8 pt-5 border-t border-[#f0f0f0] text-center text-[#999] text-[11px]">
                  <div className="font-semibold text-[#555] mb-1">Intu Med Spa</div>
                  <div>4726 Main St, Lisle IL · (630) 225-7323</div>
                  <div className="mt-1">
                    <a href="#" className="text-[#8BBCAD] underline" onClick={(e) => e.preventDefault()}>Unsubscribe</a>
                    {' · '}
                    <a href="#" className="text-[#8BBCAD] underline" onClick={(e) => e.preventDefault()}>Privacy Policy</a>
                  </div>
                </div>
              </div>
            </div>
  ...
  return (
    <button
      ...
      className={`w-full text-left px-4 py-3 border-b border-[#1a2420] hover:bg-[#0D1110] transition-colors ${
        active ? 'bg-[#0D1110] border-l-2 border-l-[#8BBCAD]' : ''
      }`}
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1.5 mt-0.5">
            <span className="text-[#8BBCAD] font-mono text-[9px]">{email.service}</span>
            {isNew && (
              <span className="text-[9px] font-mono px-1 py-0.5 rounded animate-pulse" style={{ background: 'rgba(139,188,173,0.15)', color: 'var(--accent)', border: '1px solid rgba(139,188,173,0.3)' }}>
                ✦ NEW
              </span>
            )}
          </div>
